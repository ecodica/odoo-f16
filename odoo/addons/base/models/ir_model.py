        ...
        for model in self:
            ...
            if current_model is not None:
                ...
                if kind == 'v':
                    ...
                    _logger.warning('NOT dropping table: {} CASCADE'.format(sql.Identifier(table)))
    ...
    def _drop_column(self):
        ...
        for field in self:
            ...
            if field.store:
                ...
                if is_model and tools.column_exists(self._cr, model._table, field.name) and \
                    ...
                    _logger.warning('NOT cascade dropping column {}.{}'.format(
        ...
        if tables_to_drop:
            ...
            for rel_name in tables_to_drop - tables_to_keep:
                _logger.warning('Not dropping table {}.'.format(sql.Identifier(rel_name)))
...
class IrModelRelation(models.Model):
    ...
    def _module_data_uninstall(self):
        ...
        for table in to_drop:
            _logger.warning('NOT dropping table: {} '.format(sql.Identifier(table)))
            #self._cr.execute(sql.SQL('DROP TABLE {} CASCADE').format(sql.Identifier(table)))
